...
public final class FsCaseConstants {

	/** 事件状态：未派遣 */
	public static final String FSCASE_STATUS_RESOLVEUN = "0";

	/** 事件状态：已派遣 */
	public static final String FSCASE_STATUS_RESOLVEING = "1";

	/** 事件状态：已处理 */
	public static final String FSCASE_STATUS_RESOLVEED = "2";

	/** 事件状态：已核实完成 */
	public static final String FSCASE_STATUS_VERIFYED = "4";

...
/**
 * RearService generated by hbm2java
 */
@Entity
@Table(name = "REAR_SERVICE")
public class RearService implements java.io.Serializable {
	...
	public RearService(long id) {
		this.id = id;
	}

	public RearService(long id, Date handleDate, String outQuantity,
			String process, String result, String transferGoods) {
		this.id = id;
	...
	@Column(name = "TRANSFER_GOODS", length = 510)

...
<table width="99%">
  <tr>
    <td>
      <form id="fscaseStaticForm" action="${ctx}/statisticmonth/statisticFsCaseStatus.do" method="post">
        事发时间：
			<input type="text" name="beginDate" style="width: 120px"
				value='<s:date name="beginDate" format="yyyy-MM-dd HH:mm"/>'
				onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm'})"
				class="Wdate" />
			至
			<input type="text" name="endDate" style="width: 120px"
				value='<s:date name="endDate" format="yyyy-MM-dd HH:mm"/>'
				onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm'})"
				class="Wdate" />

    	...
    	<div class="x-panel-body">    		
    		...
    		<div>
    			<fieldset style="margin:20px;lineheight:24px;">
					...
					<img src="${ctx}/pages/admin/googlemap/help.gif"/><br/>
					将系统所在域名填写到“我的网址”对应的文本框中(如：http://www.earth.com)，点“生成API密钥”按钮，页面会提示登录Google账户，
					输入用户名密码登录后将看到如下结果：<br/>
					<img src="${ctx}/pages/admin/googlemap/key.gif"/><br/> 
					复制生成的key码填入此页面文本框中保存即可。(此配置涉及事件、诚信企业和监管员在地图的正常显示)
    			</fieldset>
    		</div>    	
    	</div>
  </div>

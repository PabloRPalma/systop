...
<div class="x-panel">
  <div class="x-panel-header">用户管理</div>
    <div class="x-toolbar">
      <table width="99%">
        ...
        <s:form action="user/index" theme="simple">
        	用户类型：<s:select name="model.userType" list='#{"1":"后台用户","0":"注册用户"}' headerKey="" headerValue="全部"/>
	...
	<ec:row>
		...
		<ec:column width="60" property="userType" title="用户类型" style="text-align:center">
		  <s:if test="#attr.item.userType == 0">
		  	<font color="maroon">注册用户</font>
		  </s:if>
		  <s:else>
		    <font color="blue">后台用户</font>
		  </s:else>
		</ec:column>

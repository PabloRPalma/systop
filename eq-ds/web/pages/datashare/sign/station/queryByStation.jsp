...
<script type="text/javascript">
	...
	function showStationsTree(){
		...
		$("#stationsTree").treeview({
			collapsed: true,
			unique: false,
			url:"${ctx}/datashare/sign/station/staionsForStaTree.do?model.stationId="+sIds
		});
		...
		<table width="100%">
			...
			<tr>
			   <td align="center" colspan="2">
			       ...
			       <input type="button" value="台站分布图" onclick="queryForXML('${ctx}/datashare/sign/station/stationForStaGis.do','_blank')" style="width:80px;" class="button">
			   </td>
			</tr>
		</table>		
	  </fieldset>

...
function stockChart(){
	$("#queryChartFrom").attr("action", "${ctx}/datashare/sign/data/stock.do");
	setIds();
	$("#queryChartFrom").submit();
}

function appletkChart(){
	$("#queryChartFrom").attr("action", "${ctx}/datashare/sign/data/easyChart.do");
	setIds();
	$("#queryChartFrom").submit();
}

function zip(){
	$("#queryChartFrom").attr("action", "${ctx}/datashare/sign/data/zip.do");
	setIds();
	$("#queryChartFrom").submit();
}

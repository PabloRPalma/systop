...
<body>
  <table id="mytable" width="90%" align="center" style="text-align:center">
	...
	<tr>
		<td>${item.metaSet}</td>
		<td>
			<a href="${ctx}/datashare/index.do?type=${item.type}" target="_blank"><font color="blue">链接</font></a>
		</td>
		<td width="100px">
			<a href="${ctx}/datashare/metadata/queryMetadataInfo.do?model.type=${item.type}" target="_blank">查看</a> | 
			<a href="${ctx}/datashare/metadata/downloadMetadataInfo.do?model.type=${item.type}" target="_blank">下载</a>
		</td>
	</tr>
	</c:forEach>
  </table>

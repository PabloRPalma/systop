...
<body>
<s:form id="removeForm" action="remove" namespace="/datashare/admin/czcatalog" method="POST"></s:form>
<div class="x-panel">
    ...
    <div class="x-toolbar">
      <table width="99%">
        <tr>
         ...
         <table> 
           <tr>
             <td><a href="${ctx}/datashare/admin/czcatalog/index.do"><img src="${ctx}/images/icons/house.gif"/> 地震目录管理首页</a></td>
             <td><span class="ytb-sep"></span></td>
             <td><a href="${ctx}/datashare/admin/czcatalog/editNew.do"><img src="${ctx}/images/icons/add.gif"/> 新建地震目录</a></td>
             <td><span class="ytb-sep"></span></td>

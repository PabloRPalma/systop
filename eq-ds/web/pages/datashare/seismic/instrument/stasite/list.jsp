	...
	<legend>场地响应查询</legend>
     <table width="99%">
       <tr>
         ...
         <input value="查询" onclick="queryForList('${ctx}/datashare/seismic/instrument/stasite/list.do', '')" size="6" style="text-align: center;cursor: auto;" type="button" class="button"/>

...
<ec:table items="items" var="item" retrieveRowsCallback="process" sortRowsCallback="process" 
	...
	<ec:row>
		...
		<ec:column width="60" property="AMP" title="振幅" cell="datashare.seismic.data.phase.webapp.cell.PhaseNumCell"/>	
		<ec:column width="80" property="PERIOD" title="周期" cell="datashare.base.webapp.DoubleCell"/>	
		...
		<ec:column width="120" property="MAG_VAL" title="震级值" cell="datashare.seismic.data.catalog.webapp.cell.EMCell"/>	
		<ec:column width="120" property="DISTANCE" title="震中距" cell="datashare.seismic.data.catalog.webapp.cell.EMCell"/>	

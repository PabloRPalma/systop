package datashare.seismic.station.webapp;
...
import datashare.seismic.station.dao.AbstractStationDao;
import datashare.seismic.station.dao.GridStationDao;
import datashare.seismic.station.model.Criteria;
import datashare.seismic.station.model.InstrDic;
...
public class SeismicStationAction extends AbstractQueryAction<Criteria> {
  ...
  public List<Map> getInstrumentsMap() {
    String instrType = ResourceBundleUtil.getString(Constants.RESOURCE_BUNDLE,
        "datashare.instrtype.seismometer", "地震计");

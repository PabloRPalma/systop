package com.systop.modules.hr.dept.webapp;
...
import com.systop.modules.hr.dept.webapp.validation.DeptValidator;
...
public class DeptAction extends ExtJsCrudAction<Dept, DeptManager> {
  ...
  public String deptTree() {
    if (RequestUtil.isJsonRequest(getRequest())) {
      ...
      Map deptTree = getManager().getDeptTree(getModel().getId());
      if (!deptTree.isEmpty()) {
    	  depts = new ArrayList();
          depts.add(deptTree);
      }

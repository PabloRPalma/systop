package com.systop.modules.hr.employee.webapp;
...
import com.systop.modules.hr.HrConstants;
import com.systop.modules.hr.dept.model.Dept;
import com.systop.modules.hr.employee.model.Employee;
import com.systop.modules.hr.employee.service.EmployeeManager;
import com.systop.modules.hr.employee.webapp.validation.EmployeeValidator;
...
public class EmployeeAction extends ExtJsCrudAction<Employee, EmployeeManager> {
  ...
  public String deptEmpTree() {
    if (RequestUtil.isJsonRequest(getRequest())) {
      ...
      Map deptTree = getManager().getDeptEmpTree();
      if (!deptTree.isEmpty()) {
        deptEmps = new ArrayList();

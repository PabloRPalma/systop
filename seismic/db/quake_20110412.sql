...
INSERT INTO `softcatas` (`ID`,`DESCRIPTION`,`NAME`) VALUES 
 (1310720,'','友情链接');
...
INSERT INTO `users` (`ID`,`h_tel`,`address`,`birthday`,`data_email`,`degree`,`descn`,`email`,`folk`,`industry`,`is_sys`,`last_login_ip`,`last_login_time`,`level`,`login_id`,`login_times`,`mobile`,`msn`,`name`,`password`,`photo`,`post`,`province`,`qq`,`regist_time`,`sex`,`status`,`unit`,`unit_kind`,`user_type`,`version`,`zip`,`dept_id`) VALUES 
 (32768,NULL,'sdfhsd',NULL,'dudu88656@sohu.com','3','系统管理员角色','dudu88656@sohu.com',NULL,'N','1','127.0.0.1','2011-04-12 19:32:46',NULL,'admin',105,'13933067201',NULL,'Administrator','1d0258c2440a8d19e716292b231e3190',NULL,'a','HE',NULL,NULL,'M','1','aaa','4','1',110,'000000',NULL);

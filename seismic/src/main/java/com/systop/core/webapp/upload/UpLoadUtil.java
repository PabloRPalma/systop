...
public final class UpLoadUtil {
  ...
  public static String doUpload(File file, String fileName, String folderName, ServletContext sctx,
    ...
    //为防止文件夹下图片过多，导致系统崩溃。按yyyymm区分。
    String folderPath = sctx.getRealPath(folderName)+File.separatorChar+DateUtil.getDateTime("yyyyMM", new Date());
    ...
    try {
      ...
      return folderName+DateUtil.getDateTime("yyyyMM", new Date())+"/"+ destFileName;
    } catch (IOException e) {
      e.printStackTrace();
      return null;
    }

...
<%@page import="quake.sign.data.model.EasyChartModel"%>
<html>
<head>
...
<div style="width: 800px" align="right">
	...
	<a target="_blank" href="${ctx}/quake/sign/log/list.do?model.stationId=${dataModel.stationId}&model.pointId=${dataModel.pointId}&model.itemId=${dataModel.itemId}&model.tableCategory=DLG&model.startDate=${dataModel.minDate}&model.endDate=${dataModel.maxDate}">

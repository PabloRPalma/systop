...
<body>
<s:form name="frmRemove" id="frmRemove" method="post" action="remove" namespace="/quake/admin/counter/offline">
...
<table width="99%">
	<tr>
		...
		<table>
			<tr>
				<td>
				<a href="${ctx}/quake/admin/counter/offline/editNew.do"><img src="${ctx}/images/icons/add.gif"/>添加统计</a>
				&nbsp;<a href="${ctx}/quake/admin/counter/offline/index.do"><img

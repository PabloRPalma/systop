...
<script type="text/javascript">
	$(function(){
		...
		$('#subjects').change(function() {
			...
			$.ajax({
				url: '${ctx}/quake/sign/station/queryMethods.do',
				type: 'post',
				dataType: 'json',
			...
			$.ajax({
				url: '${ctx}/quake/sign/station/queryInstruments.do',
				type: 'post',
				dataType: 'json',
				data: {subjectId : subid},
				success: function(rows, textStatus){
		...
		$('#itemId').change(function(){
			...
			$.ajax({
				url:'${ctx}/quake/sign/station/queryInstrumentsByMethod.do',
				type:'post',
				dataType:'json',
	...
	function showStationsTree(){
		...
		$("#stationsTree").treeview({
			collapsed: true,
			unique: false,
			url:"${ctx}/quake/sign/station/staionsTree.do?model.subjectId="+subjectId+"&model.instrCode=" + instrCode + "&model.itemId=" + itemId
		});
		...
		<table width="100%">
			...
			<tr>
			   <td align="center" colspan="2">
			       ...
			       <input type="button" value="台站分布图" onclick="queryForXML('${ctx}/quake/sign/station/stationGis.do','_blank')" style="width:80px;" class="button">
			   </td>
			</tr>
		</table>
	</fieldset>

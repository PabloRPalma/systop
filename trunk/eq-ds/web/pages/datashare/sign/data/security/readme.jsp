...
<p><b class="pmt">提示：</b>你可以单击这个连接<a href="${ctx}/pages/datashare/sign/data/security/java_policy.zip">下载已经修改好的<em>java.policy</em>文件</a>，将解压出来的<em>java.policy</em>文件复制到<em>lib\security</em>目录替换相同的文件。</p>
<p>3）重新启动浏览器</p>

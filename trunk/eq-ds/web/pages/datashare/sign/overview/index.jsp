...
<legend>数据总览</legend>
   ...
   <div class="x-panel-body">
	...
	<ec:row>
		...
		<ec:column width="140" property="START_DATE" title="数据起始时间" cell="datashare.base.webapp.DateTimeCell"/>
		<ec:column width="140" property="END_DATE" title="数据结束时间" cell="datashare.base.webapp.DateTimeCell"/>

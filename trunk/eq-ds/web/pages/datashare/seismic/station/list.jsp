...
<fieldset>
	...
	<s:form action="list" theme="simple" id="queryFrm">
     ...
     <tr>
       ...
       <td>
	   <input value="查询" onclick="queryForList('${ctx}/datashare/seismic/station/list.do', '')" size="6" style="text-align: center;cursor: auto;" type="button" class="button"/>
       <input value="台站分布图" onclick="queryForList('${ctx}/datashare/seismic/station/stationGis.do', '_blank')" style="text-align: center;cursor: auto;" type="button" class="button"/>
...
function xmlUrlPath() {
	...
	window.location='${ctx}'+ "/datashare/seismic/station/xmlUrlJsp.do?ctxUrl="+cUrl+"&model.startDate="+stDate+"&model.endDate="+edDate+"&model.instrumentId="+instrId+"&model.datarecordId="+datId;
}
//以xls格式导出测震台站信息列表

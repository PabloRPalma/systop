...
<body>
<s:form id="removeForm" action="remove" namespace="/datashare/admin/samplerate" method="POST"></s:form>
<div class="x-panel">
        ...
        <tr>
         ...
         <table> 
           <tr>
             ...
             <td><a href="${ctx}/datashare/admin/samplerate/index.do"><img src="${ctx}/images/icons/house.gif"/> 采样率首页</a></td>
             <td><span class="ytb-sep"></span></td>
             <td><a href="${ctx}/datashare/admin/samplerate/editNew.do"><img src="${ctx}/images/icons/add.gif"/> 新建采样率</a></td>
           </tr>
         </table>
         <td>
       </tr>
...
function changeEnable(cbx) {
   ...
   $.ajax({
      url:'${ctx}/datashare/admin/samplerate/changeEnabled.do?model.id=' + $(cbx).val() + '&model.enabled=' + checked,
...
function changeMail(cbx) {
   var checked = cbx.checked ? '1' : '0';
   $.ajax({
      url:'${ctx}/datashare/admin/samplerate/changeForMail.do?model.id=' + $(cbx).val() + '&model.forMail=' + checked,
      beforeSend: function(){$('#loading').show();},
      success:function(){$('#loading').fadeOut();}
   });
}

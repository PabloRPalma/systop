...
<body>
<div class="x-panel">
<div class="x-panel-header">数据下载统计</div>
<div class="x-toolbar">
<table width="99%">
	<tr>
		<td>
		...
		<table>
			<tr>
				<td><a href="${ctx}/datashare/admin/counter/down/index.do"><img
					src="${ctx}/images/icons/house.gif" /> 数据下载统计首页</a></td>
			</tr>
		</table>
		<td>
	</tr>
...
<div style="margin-left: -3px;" align="center"><ec:table
	items="items" var="item" retrieveRowsCallback="process"
	...
	<ec:row>
		...
		<ec:column width="340" property="month" title="下载时间" />
		<ec:column width="140" property="hits" title="下载次数" calc="total" calcSpan="2"  calcTitle="总计"/>
	</ec:row>
</ec:table></div>
</div>
</div>

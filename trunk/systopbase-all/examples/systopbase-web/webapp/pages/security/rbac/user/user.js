...
var win = new Ext.Window({
	...
	tbar : [tbarItems, {
		...
		handler : function() {
			Ext.Ajax.request({
				url : '/security/rbac/role/saveUserRoles.do',
				params : {
...
function cancelAssign() {
	Ext.Ajax.request({
		url : '/security/rbac/role/cancelSaveUserRoles.do',
		params : {
			'user.id' : currentUserId
		},
		method : 'POST'
...
function onSelectRole(cb) {
	var url = (cb.checked)
			? '/security/rbac/role/selectRole.do'
			: '/security/rbac/role/deselectRole.do';
	Ext.Ajax.request({
		url : url,
		params : {
			'user.id' : currentUserId,
...
function url() {
	var urlStr =  '/security/rbac/role/rolesOfUser.do?user.id=' + currentUserId;

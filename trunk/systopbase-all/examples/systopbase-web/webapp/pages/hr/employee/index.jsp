...
<font color="white">员工姓名：</font><s:textfield name="model.name" size="15"/>
</s:form>
</div>
<div class="x-panel">
...
<script type="text/javascript" src="${ctx}/pages/security/rbac/user/user.js"></script>
<script type="text/javascript" src="${ctx}/pages/hr/employee/index.js"></script>

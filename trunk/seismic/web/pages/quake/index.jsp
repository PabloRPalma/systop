...
<script type="text/javascript">
	$(function(){
		...
		//var srcStr = '${ctx}/quake/descr/queryDescribe.do?model.type=seismicNetDescn&model.hasMetadata=0';
		    ...
		    <div>
				<ul id="stations" style="margin:10px 10px 10px 10px">
					<li><span><b><img src="${ctx}/images/icons/folder.gif">&nbsp;测震台网</b></span>
						<ul>
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/descr/queryDescribe.do?model.type=seismicNetDescn&model.hasMetadata=0" target="main">台网概述</a></li>
							<li><img src="${ctx}/images/icons/go.gif" class="icon"><a href="${ctx}/quake/seismic/station/list.do" target="main">测震台站查询</a></li>
							<li><img src="${ctx}/images/icons/go.gif" class="icon"><a href="${ctx}/quake/seismic/instrument/channel/list.do" target="main">通道参数查询</a></li>
							<li><img src="${ctx}/images/icons/go.gif" class="icon"><a href="${ctx}/quake/seismic/instrument/stasite/list.do" target="main">场地响应查询</a></li>
						</ul>
					</li>
					<li><span><strong><img src="${ctx}/images/icons/folder.gif">&nbsp;前兆台网</strong></span>
						<ul>
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/descr/queryDescribe.do?model.type=signNetDescn&model.hasMetadata=0" target="main">台网概述</a></li>
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/sign/station/indexForSta.do" target="main" title="按台站查询">台站查询(按台站)</a></li>
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/sign/station/index.do" target="main" title="按学科-测项-仪器查询">台站查询(按学科)</a></li>
						</ul>
					</li>
				</ul>
			</div>
		    ...
		    <div>
				<ul id="dataService" style="margin:10px 10px 10px 10px">
					  ...
					  <li><span><b><img id="note_phase" src="${ctx}/images/icons/folder.gif">&nbsp;<a id="phase" href="${ctx}/quake/descr/queryDescribe.do?model.type=phase&model.hasMetadata=1" target="main">震相</a></b></span>
					    <ul>
							<s:iterator value="pHASECATS"> 
								<li>
								  <img src="${ctx}/images/icons/go.gif">
									<a href="${ctx}/quake/seismic/data/catalog/indexPhase.do?model.tableName=<s:property value="cltName"/>" target="main">
									  <s:property value="clcName"/>
									</a>
								</li>
							</s:iterator>
					...
					<stc:role ifAnyGranted="ROLE_SENIOR,ROLE_ADMIN,ROLE_EVENT">
					  <li><span><img id="note_eventWave" src="${ctx}/images/icons/folder.gif">&nbsp;<a id="eventWave" href="${ctx}/quake/descr/queryDescribe.do?model.type=eventWave&model.hasMetadata=1" target="main"><b>事件波形</b></a></span>
					    <ul>
							<s:iterator value="SEEDCATS">
								<li>
								  <img src="${ctx}/images/icons/go.gif">
									<a href="${ctx}/quake/seismic/data/catalog/indexSeed.do?model.tableName=<s:property value="cltName"/>" target="main">
									  <s:property value="clcName"/>
									</a>
								</li>
							</s:iterator>
					 ...
					 <stc:role ifAnyGranted="ROLE_SENIOR,ROLE_ADMIN,ROLE_CONTINUE">
					  <li><img id="note_sequenceWave" src="${ctx}/images/icons/folder.gif">&nbsp;<a id="sequenceWave" href="${ctx}/quake/descr/queryDescribe.do?model.type=sequenceWave&model.hasMetadata=1" target="main"><b>连续波形</b></a></li>
					 </stc:role>
					</ul>
					</li>
					<li><span><strong><img id="note_signMetadata" src="${ctx}/images/icons/folder.gif">&nbsp;<a id="signMetadata" href="${ctx}/quake/descr/queryDescribe.do?model.type=signMetadata&model.hasMetadata=1" target="main"><b>地球物理化学数据</b></a></strong></span>
						<ul>
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/sign/overview/index.do" target="main" title="前兆数据总览">数据总览</a></li>
							<s:iterator value="SUBJECTS" var="subject">
							<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/prequery/index.do?subject.id=${subject.id}" target="main">${subject.name}</a></li>	
							</s:iterator>
						</ul>
					</li>
				</ul>
		...
		<div>
		    ...
		    <div>
				<ul id="mailPreorder" style="margin:10px 10px 10px 10px">
					<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/email/sign/index.do" target="main">订阅前兆数据</a></li>
					<li><img src="${ctx}/images/icons/go.gif"><a href="${ctx}/quake/email/seismic/index.do" target="main">订阅测震数据</a></li>
				</ul>
			</div>
		</div>

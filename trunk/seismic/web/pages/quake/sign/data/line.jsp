...
so.addVariable("settings_file", escape("${ctx}/quake/sign/data/lineSettings.do${model}"));
so.addVariable("data_file", escape("${ctx}/quake/sign/data/csv.do${model}"));
...
<button value="Reload" onclick="flashMovie.reloadData(escape('${ctx}/quake/sign/data/csv.do${model}'), false)">Reload</button>

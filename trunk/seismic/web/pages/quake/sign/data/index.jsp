...
<script type="text/javascript">
	...
	function showStationsTree(){
		...
		$("#stationsTree").treeview({
			collapsed: false,
			unique: false,
			url:"${ctx}/quake/prequery/staionsTree.do?tableCategory=" + tableCategory + "&sampleRate=" + sampleRate + "&methodId=" + methodId
		});
	...
	function query(){	
		...
		$("#querySignData")[0].action="${ctx}/quake/sign/data/list.do";
...
<div class="ui-layout-west" style="padding:5px;overflow: auto;">
	<form id="querySignData" action="${ctx}/quake/sign/data/list.do" target="signData" method="post">

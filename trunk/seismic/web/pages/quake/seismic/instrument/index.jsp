		...
		<table width="99%" style="margin:0px;">
			<tr>
				<td style="vertical-align: text-top;">
					台网：<s:select list="netCodes" name="ntCode" headerKey="" headerValue="--全部--" cssStyle="width:100px;"></s:select>
					仪器类型：<s:select list="instrTypes" name="model.instrType" headerKey="" headerValue="--全部--" cssStyle="width:100px;"></s:select>
					用途类型：<s:select list="useTypes" name="model.useType" headerKey="" headerValue="--全部--" cssStyle="width:100px;"></s:select>
...
<ec:table items="items" var="item" retrieveRowsCallback="limit" sortRowsCallback="limit" 
	...
	<ec:row>
		...
		<ec:column width="100" property="Instr_model" title="仪器型号" />
		<ec:column width="100" property="Instru_sn" title="仪器序列号" />	
		<ec:column width="70" property="Mac" title="MAC地址" />
		<ec:column width="70" property="Instr_ver" title="版本号" />	
		<ec:column width="70" property="Use_type" title="用途类型" mappingItem="UseTypes"/>	
		<ec:column width="130" property="Ondate" title="启用时间" cell="date" format="yyyy-MM-dd HH:ss"/>
		<ec:column width="130" property="Offdate" title="终止时间" cell="date" format="yyyy-MM-dd HH:ss"/>
		<ec:column width="130" property="staName" title="所在台站" />
	</ec:row>   
</ec:table>
</div>
<script type="text/javascript">

	  ...
	  <table width="100%">	      
		<tr>	         
		  <td align="right">   
			<table>
			  <tr>
      <td><a href="${ctx}/quake/admin/samplerate/index.do"> 采样率管理首页</a></td> 
...
<s:form action="save" namespace="/quake/admin/samplerate" validate="true" theme="simple" onsubmit="return onSubmit()">

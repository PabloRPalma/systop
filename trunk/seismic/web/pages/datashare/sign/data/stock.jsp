<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.List,quake.sign.data.model.Criteria"
    pageEncoding="UTF-8"%>
...
<s:iterator value="criteriaList" var="criteria"> 
	...
	<script type="text/javascript">
		...
		encodeURIComponent("${ctx}/quake/sign/data/stockSettings.do${criteria}"));
...
<form id="queryLogFrom" action="${ctx}/quake/sign/log/list.do" method="get" target="_blank">

package com.systop.common.webapp.taglibs.freemarker;
...
import com.systop.common.webapp.taglibs.template.FreeMarkerTemplateRender;
import com.systop.common.webapp.taglibs.template.LayoutTemplate;
...
public abstract class BaseFreeMarkerTagSupport extends
  ...
  /**
   * @param templateDir the templetDir to set
   */
  ...
  /**
   * @param templateName the templetName to set
   */
  public void setTemplateName(String templateName) {
	  
    this.templateName = (templateName == null 
    		? this.getDefaultTemplate() : templateName);
  }
  ...
  protected TemplateContext initTempateContext() {
    ...
    if (StringUtils.isBlank(theme)) {
      theme = Constants.DEFAULT_TEMPLATE_THEME;
    }
    LayoutTemplate template = new LayoutTemplate(templateDir, theme, 
    		templateName,  x.toString(), y.toString(),
    		width, visible.toString());
  ...
  public int doEndTag() throws JspException {
    ...
    FreeMarkerTemplateRender render = 
      (FreeMarkerTemplateRender) getBean("freemarkerTemplateRender");
    try {

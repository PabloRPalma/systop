...
function fastsend(sendtypeid){
	...
	var id = document.getElementById('eventid').value;
	url="${ctx}/sendType/send.do?model.id=" + sendtypeid + "&eventid=" + id;
	window.open(url,'main'); 
}
</script>
</head>
...
<table align="center" width="567" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><img src="${ctx}/images/choosesendtype/top.gif" width="567" height="35" /></td>
  </tr>
</table>
<table align="center" width="567" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <tr>
    <td background="${ctx}/images/choosesendtype/table_bg.gif">
    	<table align="center" width="567" height="35" border="0" cellpadding="0" cellspacing="0">
    		<tr><td><br></tr>
    		<tr>
	<td><input id="eventid" type="hidden" value="${singleEventID}" /></td>
	</tr>
        		<s:iterator value="sendTypeMap" var="type">
        		<tr>
        		<td>
        			<input onclick="fastsend(${type.key})" type="button" value="${type.value}" style="width:555px; height:35px; border: 0px; background-image: url(${ctx}/images/choosesendtype/01.gif);font-size:16px;color:#000"/>
        		</td>
        		</tr>
        		<tr><td><br></td></tr>
        		</s:iterator>

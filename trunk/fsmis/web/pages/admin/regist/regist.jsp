...
<table width="820" align="center" style="margin: 5px">
	<tr>
		<td align="left">请填写个人资料：（注意带有<font color="red">*</font>的项目必须填写）</td>
	</tr>
</table>
<s:form action="confirm" theme="simple" id="save" validate="true"
	method="POST">
	...
	<table id="mytable" align="center">
		...
		<tr>
			...
			<td class="simple">&nbsp;<s:radio list="userLevelMap"
				name="model.level" cssStyle="border:0px;" /> <font color="red">*</font>&nbsp;&nbsp;<a href="${ctx}/registfile/register.doc">申请表下载</a></td>
	...
	<table width="100%" style="margin-bottom: 10px;">
		<tr>
			<td colspan="2" align="center" class="font_white" style="padding-top: 15px">
				<s:submit value="提交注册信息" cssClass="button"/>&nbsp;&nbsp; 

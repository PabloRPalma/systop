...
public class UserManager extends BaseGenericsManager<User> {
	...
	public void addUserLoginHistory(User user, String loginIp) {
		...
		UserLoginHistory userLoginHistory = new UserLoginHistory(user,
				new Date(), loginIp, user.getDept());
	...
	public List<User> getUserByName(String uId, String uName) {
		...
		if (StringUtils.isNotBlank(uId)) {
			hql.append(" and u.id != ?");
			list = query(hql.toString(), new Object[] { uName,
					Integer.valueOf(uId) });
		} else {
	...
	public List<User> getUserByEmail(String uId, String email) {
		...
		if (StringUtils.isNotBlank(uId)) {
			hql.append(" and u.id != ?");
			list = query(hql.toString(), new Object[] { email,
					Integer.valueOf(uId) });
		} else {
